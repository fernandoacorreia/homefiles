...
export PROMPT_GREEN='\[\033[01;32m\]'
export PROMPT_BLUE='\[\033[01;34m\]'
export PROMPT_WHITE='\[\033[00m\]'
export PROMPT_COMMAND='__git_ps1 "${debian_chroot:+($debian_chroot)}$PROMPT_GREEN\u@\h$PROMPT_WHITE:$PROMPT_BLUE\w$PROMPT_WHITE" "\\n$PROMPT_BLUE\\\$$PROMPT_WHITE "'
